...
| `--bridge.<mesh-id>.raft.election-timeout`          | `bridge.<mesh-id>.raft.election-timeout`          | `2s`                     | Raft election timeout.                          |
...
| `--bridge.<mesh-id>.raft.heartbeat-timeout`         | `bridge.<mesh-id>.raft.heartbeat-timeout`         | `2s`                     | Raft heartbeat timeout.                         |
| `--bridge.<mesh-id>.raft.in-memory`                 | `bridge.<mesh-id>.raft.in-memory`                 | `false`                  | Run raft with in-memory storage.                |
| `--bridge.<mesh-id>.raft.leader-lease-timeout`      | `bridge.<mesh-id>.raft.leader-lease-timeout`      | `2s`                     | Raft leader lease timeout.                      |
