...
| `--raft.election-timeout` | `RAFT_ELECTION_TIMEOUT` | `raft.election-timeout` | `2s` | Raft election timeout. |
...
| `--raft.heartbeat-timeout` | `RAFT_HEARTBEAT_TIMEOUT` | `raft.heartbeat-timeout` | `2s` | Raft heartbeat timeout. |
| `--raft.in-memory` | `RAFT_IN_MEMORY` | `raft.in-memory` | `false` | Run raft with in-memory storage. |
| `--raft.leader-lease-timeout` | `RAFT_LEADER_LEASE_TIMEOUT` | `raft.leader-lease-timeout` | `2s` | Raft leader lease timeout. |
